...
import { Heart, Star, Snowflake, Circle, Maximize2, Minimize2, Video, VideoOff, Palette, Music, VolumeX } from 'lucide-react';
...
export const Controls: React.FC<ControlsProps> = ({
  ...
  return (
    <div className="absolute inset-0 pointer-events-none flex flex-col justify-between p-6 z-10">
      ...
      {/* Guide Toast */}
      {isCameraEnabled && (
        <div className="absolute top-24 left-1/2 -translate-x-1/2 pointer-events-none w-full flex justify-center">
